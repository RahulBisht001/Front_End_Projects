...
const drawRectangle = (e) => {
    ...
    */
    ...
    if (!fillColor.checked) {
        return cxt.strokeRect(e.offsetX, e.offsetY, prevMouseX - e.offsetX, prevMouseY - e.offsetY)
    }
    cxt.fillRect(e.offsetX, e.offsetY, prevMouseX - e.offsetX, prevMouseY - e.offsetY)
}
